...
def Main():
	fileprefix = 'data\\'
	mapfile = fileprefix + 'tx_with_ml_2d_scan2_UMSmap.txt'
	...
	np.savetxt("PressureMap_in_Pa.csv", datatofile, delimiter=",", header='1st row: X, 1st col: Y')
	exit()
	...
	np.savetxt("PressureMap.csv", datatofile, delimiter=",", header='1st row: X, 1st col: Y')
	#######################################
